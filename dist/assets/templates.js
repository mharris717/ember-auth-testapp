...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.partial || depth0.partial),stack1 ? stack1.call(depth0, "user_status", options) : helperMissing.call(depth0, "partial", "user_status", options))));
  data.buffer.push("\n\n");
  hashTypes = {};
  hashContexts = {};
